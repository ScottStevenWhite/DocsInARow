...
def get_windows_folder(CSIDL_FOLDER):
    ...
    if windll.shell32.SHGetFolderPathW(None, CSIDL_FOLDER, None, SHGFP_TYPE_CURRENT, path):
        raise RuntimeError(f"Unable to retrieve the folder path for CSIDL {CSIDL_FOLDER}")
